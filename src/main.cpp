...
int main() {
    ...
    ParticleFilter pf(sigma_pos, sensor_range);
    
    h.onMessage([&pf,&map,&delta_t, &sigma_landmark]
                        ...
                        if (s != "") {
                            ...
                            if (event == "telemetry") {
                                ...
                                if (!pf.initialized()) {
                                    ...
                                    pf.predictGlobalCoord(delta_t, previous_velocity, previous_yawrate);
                                }
                                ...
                                pf.updateWeights(sigma_landmark, noisy_observations, map);
                                pf.resample();
